...
export const DonationIcon = () => (
  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-2.21 0-4 1.343-4 3s1.79 3 4 3 4 1.343 4 3-1.79 3-4 3m0-12c1.74 0 3.221.833 3.775 2M12 8V5m0 3v12m0 0v-3m0 3c-1.74 0-3.221-.833-3.775-2" />
  </svg>
);
