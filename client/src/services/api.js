...
export const campaignAPI = {
  ...
  getMissionApplications: (params) => api.get('/campaigns/mission-applications/manage', { params }),
  reviewMissionApplication: (id, data) => api.patch(`/campaigns/mission-applications/${id}/status`, data),
  getMissionTaskBoard: (missionId) => api.get(`/campaigns/missions/${missionId}/task-board`),
  updateMissionTaskAssignment: (missionId, assignmentId, data) => api.patch(`/campaigns/missions/${missionId}/assignments/${assignmentId}`, data),
